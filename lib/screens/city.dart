      ...
      builder: ((context, snapshot) {
        {
          ...
          if (snapshot.hasData && snapshot.data!.isNotEmpty) {
            return Scaffold(
              key: _scaffoldKey,
              backgroundColor: WeatherIdentifier(snapshot.data![0]['weather']),
              appBar: AppBar(
                backgroundColor:
                ...
                child: ListView(
                  ...
                  children: [
                    CityCard(
                        ...
                        snapshot.data![1]['weather'],
                        snapshot.data![2]['weather'],
                        snapshot.data![3]['weather'],
                        snapshot.data![4]['weather'],
                        snapshot.data![0]['temp'],
                        snapshot.data![1]['temp'],
                        snapshot.data![2]['temp'],
                        snapshot.data![3]['temp'],
                        snapshot.data![4]['temp'],
                        snapshot.data![0]['timer'],
                        snapshot.data![1]['timer'],
                        snapshot.data![2]['timer'],
                        snapshot.data![3]['timer'],
                        snapshot.data![4]['timer'],
                    ...
                    WetherCard(
                        ...
                        _isDarkMode
                            ? BgColor.BgAppbarWhite
                            : BgColor.BgAppbarBlack,
                        snapshot.data![5]['timer'],
                        snapshot.data![6]['timer'],
                        snapshot.data![7]['timer'],
                        snapshot.data![8]['timer'],
                        snapshot.data![9]['timer'],
                        snapshot.data![5]['humidity'],
                        snapshot.data![6]['humidity'],
                        snapshot.data![7]['humidity'],
                        snapshot.data![8]['humidity'],
                        snapshot.data![9]['humidity'],
                        snapshot.data![5]['weather'],
                        snapshot.data![6]['weather'],
                        snapshot.data![7]['weather'],
                        snapshot.data![8]['weather'],
                        snapshot.data![9]['weather'],
                        snapshot.data![5]['temp'],
                        snapshot.data![6]['temp'],
                        snapshot.data![7]['temp'],
                        snapshot.data![8]['temp'],
                        snapshot.data![9]['temp']),
                  ],
                ),
              ),
            );
